...
class LoginFragment : Fragment(R.layout.fragment_login) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel = StudentAuthViewModel(StudentAuthRepository(remoteDataSource.buildApi(StudentAuthApi::class.java), userPreferences))
        ...
        binding.password.addTextChangedListener {
            ...
            binding.loginButton.enable(it.toString().isNotEmpty() && username.isNotEmpty() && it.toString().length == 4 && username.length == 11)
        }
