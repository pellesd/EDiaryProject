...
import hu.ocist.enaplo.login.databinding.GradesListRowBinding
import hu.ocist.enaplo.login.ui.stringToDateFormat
import hu.ocist.enaplo.login.ui.visible

class GradesRecyclerViewAdapter() :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): GradesViewHolder {
        this.parent = parent
        return GradesViewHolder(GradesListRowBinding.inflate(LayoutInflater.from(parent.context), parent, false))
    }
    ...
    inner class GradesViewHolder(
        val binding: GradesListRowBinding
