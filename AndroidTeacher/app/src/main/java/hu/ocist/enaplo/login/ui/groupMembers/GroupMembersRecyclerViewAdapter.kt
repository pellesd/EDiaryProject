...
class GroupMembersRecyclerViewAdapter :
    ...
    override fun onBindViewHolder(holder: GroupMembersViewHolder, position: Int) {
        ...
        if (position % 2 == 1) {
            holder.binding.line.setBackgroundColor(holder.binding.line.context.getColor(R.color.light))
        } else {
            holder.binding.line.setBackgroundColor(holder.binding.line.context.getColor(R.color.primer_content))
        }
